    ...
    programs.firefox = {
      ...
      policies = {
        ...
        ExtensionSettings = {
          ...
          "{c45c406e-ab73-4d4d-90ee-37297e69bb9f}" = { # Surfshark
            install_url = "https://addons.mozilla.org/firefox/downloads/latest/surfshark-vpn-proxy/latest.xpi";
            installation_mode = "force_installed";
          };
          "{7414512c-f056-4740-b333-855146909459}" = { # ClearURLs
            install_url = "https://addons.mozilla.org/firefox/downloads/latest/clearurls/latest.xpi";
            installation_mode = "force_installed";
          };
          "jid1-Mnnj3D6pJgNwiw@jetpack" = { # Privacy Badger
          ...
          "{9610996c-54a7-471e-be2c-474070a72061}" = { # Chrome Mask
            install_url = "https://addons.mozilla.org/firefox/downloads/latest/chrome-mask/latest.xpi";
            installation_mode = "force_installed";
          };
          "{762f9885-5a13-4abb-9c76-993d3d63b913}" = { # Return YouTube Dislike
