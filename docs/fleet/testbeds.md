# Testbeds & Experimental Nodes 🧪

This section covers staging environments and experimental desktop testbeds in Solar.

______________________________________________________________________

## 🧪 1. Io (COSMIC Desktop Testbed)

**Io** serves as the testbed and proving ground for next-generation desktop environments, experimental kernel builds, and new module features before rollout across the fleet.
