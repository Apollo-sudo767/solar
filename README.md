...
│       ├── phosphorus/     # K3s Cluster Node (Lenovo M920q Tiny, Server Suite, Limine)
...
- **`phosphorus`** — *K3s Cluster Node*: Lenovo ThinkCentre M920q Tiny (16GB RAM), `suites.server`, Limine bootloader, Disko Btrfs on NVMe, K3s control-plane/worker peer, Tailscale mesh connectivity.
