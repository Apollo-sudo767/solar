...
let
  cfg = config.myFeatures.platforms.styling.noctaliaDefaults;
...
in
{
  options.myFeatures.platforms.styling.noctaliaDefaults.enable =
    lib.mkEnableOption "Apollo's Noctalia Defaults";
      ...
      programs.noctalia-shell = {
        settings = {
          ...
          ui = {
            ...
            panelBackgroundOpacity = lib.mkForce 1.0;
