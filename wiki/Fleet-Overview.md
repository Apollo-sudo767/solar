...
| **`phosphorus`** | Morning Star (Venus) | **K3s Cluster Node**<br>• Repurposed Intel Node (16GB RAM) | Headless server, Limine bootloader, Disko Btrfs on NVMe, K3s control-plane/worker peer, Tailscale mesh connectivity. |
